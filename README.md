...
This is the code repository for the [JavaScript Date Picker: Using Diagonal Cell Split to Show Partial Free/Busy State](https://code.daypilot.org/58690/javascript-date-picker-using-diagonal-cell-split) tutorial by [DayPilot](https://www.daypilot.org/).
